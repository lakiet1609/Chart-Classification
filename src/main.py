...
def get_args():
    ...
    parser.add_argument('--batch-size', '-b', type=int, default=4, help='batch size of the dataset')
    ...
    parser.add_argument('--train-path', '-p', type=str, default=r'images\train', help='train path')
    parser.add_argument('--test-path', '-q', type=str, default=r'images\test', help='test path')
...
def main(args):
    ...
    model = torchvision.models.efficientnet_b6(weights=weights).to(device=device)
