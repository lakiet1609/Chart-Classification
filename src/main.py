...
def get_args():
    ...
    parser.add_argument('--train-path', '-p', type=str, default='images/train', help='train path')
    parser.add_argument('--test-path', '-q', type=str, default='images/test', help='test path')
